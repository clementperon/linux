...
#define SUN50I_H616_PLL_SDM_ENABLE		BIT(24)
#define SUN50I_H616_PLL_OUTPUT_ENABLE		BIT(27)
#define SUN50I_H616_PLL_LOCK			BIT(28)
#define SUN50I_H616_PLL_LOCK_ENABLE		BIT(29)
#define SUN50I_H616_PLL_ENABLE			BIT(31)
...
static struct ccu_mult pll_cpux_clk = {
	.enable		= SUN50I_H616_PLL_ENABLE,
	.lock		= SUN50I_H616_PLL_LOCK,
	.mult		= _SUNXI_CCU_MULT_MIN(8, 8, 12),
	.common		= {
		.reg		= SUN50I_H616_PLL_CPUX_REG,
...
static struct ccu_nkmp pll_periph0_clk = {
	...
	.fixed_post_div	= 2,
	.common		= {
		.reg		= SUN50I_H616_PLL_PERIPH0_REG,
...
static struct ccu_nkmp pll_periph1_clk = {
	...
	.fixed_post_div	= 2,
	.common		= {
		.reg		= SUN50I_H616_PLL_PERIPH1_REG,
		.features	= CCU_FEATURE_FIXED_POSTDIV,
...
static struct ccu_nm pll_video0_clk = {
	...
	.common		= {
		.reg		= SUN50I_H616_PLL_VIDEO0_REG,
		.features	= CCU_FEATURE_FIXED_POSTDIV,
...
static struct ccu_nm pll_video1_clk = {
	...
	.max_rate	= 2400000000UL,
	.common		= {
		.reg		= SUN50I_H616_PLL_VIDEO1_REG,
		.features	= CCU_FEATURE_FIXED_POSTDIV,
...
static struct ccu_nm pll_video2_clk = {
	...
	.max_rate	= 2400000000UL,
	.common		= {
		.reg		= SUN50I_H616_PLL_VIDEO2_REG,
		.features	= CCU_FEATURE_FIXED_POSTDIV,
...
#define SUN50I_H616_PLL_HSIC_REG		0x070
...
static struct ccu_nm pll_audio_base_clk = {
	...
	.sdm		= _SUNXI_CCU_SDM(pll_audio_sdm_table,
					 BIT(24), 0x178, SUN50I_H616_PLL_ENABLE),
	.common		= {
		.features	= CCU_FEATURE_SIGMA_DELTA_MOD,
		.reg		= SUN50I_H616_PLL_AUDIO_REG,
...
static SUNXI_CCU_GATE(avs_clk, "avs", "osc24M", 0x740, SUN50I_H616_PLL_ENABLE, 0);
...
static SUNXI_CCU_GATE(usb_ohci0_clk, "usb-ohci0", "osc12M", 0xa70, SUN50I_H616_PLL_ENABLE, 0);
...
static SUNXI_CCU_GATE(usb_ohci3_clk, "usb-ohci3", "osc12M", 0xa7c, SUN50I_H616_PLL_ENABLE, 0);
...
static SUNXI_CCU_GATE(pcie_ref_clk, "pcie-ref", "pcie-ref-100M",
		      0xab0, SUN50I_H616_PLL_ENABLE, 0);
...
static SUNXI_CCU_GATE(hdmi_slow_clk, "hdmi-slow", "osc24M", 0xb04, SUN50I_H616_PLL_ENABLE, 0);
...
static CLK_FIXED_FACTOR_HW(pll_video1_4x_clk, "pll-video1-4x",
			   ...
			   1, 4, CLK_SET_RATE_PARENT);
static CLK_FIXED_FACTOR_HW(pll_video1_4x_clk, "pll-video2-4x",
			   &pll_video1_clk.common.hw,
			   1, 4, CLK_SET_RATE_PARENT);
...
static struct clk_hw_onecell_data sun50i_h616_hw_clks = {
	.hws	= {
		...
		[CLK_BUS_SPI1]		= &bus_spi1clk.common.hw,
...
static struct ccu_reset_map sun50i_h616_ccu_resets[] = {
	...
	[RST_USB_HSIC]		= { 0xa7c, SUN50I_H616_PLL_LOCK },
