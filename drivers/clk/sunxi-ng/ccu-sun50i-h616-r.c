...
static struct ccu_reset_map sun50i_h616_r_ccu_resets[] = {
	...
	[RST_R_APB1_BUS_W1]	=  { 0x1ec, BIT(16) },
...
static int sun50i_h616_r_ccu_probe(struct platform_device *pdev)
{
	void __iomem *reg;
	...
	return sunxi_ccu_probe(pdev->dev.of_node, reg, &sun50i_h616_r_ccu_desc);
}

static const struct of_device_id sun50i_h616_r_ccu_ids[] = {
	{ .compatible = "allwinner,sun50i-h616-r-ccu" },
	{ }
};

static struct platform_driver sun50i_h616_r_ccu_driver = {
	.probe	= sun50i_h616_r_ccu_probe,
	.driver	= {
		.name	= "sun50i-h616-r-ccu",
		.of_match_table	= sun50i_h616_r_ccu_ids,
	},
};
module_platform_driver(sun50i_h616_r_ccu_driver);
